...
bwa mem -t 64 the_5SrRNA.fa \
 ...
 | samtools view -bS - > Mo17_450bp.bam
perl get_the_detailed_mapping_information_from_bwa_bam_file.pl Mo17_450bp.bam 0 > Mo17_450bp.bam.infor 
...
# samtools view -bS Mo17_800bp.sam > Mo17_800bp.bam
# perl ~/wangzijian/scripts/map/get_the_detailed_mapping_information_from_bwa_bam_file.pl Mo17_800bp.bam 0 > Mo17_800bp.bam.infor
wait
