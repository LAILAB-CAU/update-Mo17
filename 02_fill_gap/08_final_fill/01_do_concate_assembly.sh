...
samtools faidx ${thePier}    G12L:38-469394                                     | seqkit seq       -s -w 0 >> chr1.fa
...
# chr2
echo -e ">chr2" > chr2.fa                                
samtools faidx ${pbcanu}     tig00005959:24982-794130                           | seqkit seq -r -p -s -w 0 >> chr2.fa
samtools faidx ${thePier}    G21L:148348-272365                                 | seqkit seq       -s -w 0 >> chr2.fa
# echo -e ">chr2_2" >> chr2.fa
samtools faidx ${thePier}    G21R:56457-218684                                  | seqkit seq       -s -w 0 >> chr2.fa      
...
samtools faidx ${pbhifiasm}  ptg000148l:9165444-17749270                        | seqkit seq       -s -w 0 >> chr2.fa
...
# chr3
echo -e ">chr3" > chr3.fa
# samtools faidx ${theread}    fd901b24-3984-4240-b23d-d1ece0308790:59492-71500   | seqkit seq -r -p -s -w 0 >> chr3.fa
samtools faidx ${ontasm}     Contig8:10193-242776723                            | seqkit seq       -s -w 0 >> chr3.fa   
samtools faidx ${theread}    a1aa57af-0fff-49a5-9753-ba1085e2b298:1-77443       | seqkit seq       -s -w 0 >> chr3.fa                        

# chr4
echo -e ">chr4" > chr4.fa
samtools faidx ${theread}    5e5e7e17-6221-496b-8257-14fb726da7ba:141877-142460 | seqkit seq -r -p -s -w 0 >> chr4.fa
samtools faidx ${ontasm}     Contig9:1-16765204                                 | seqkit seq       -s -w 0 >> chr4.fa                                                      
samtools faidx ${thePier}    G41L:27-1254592                                    | seqkit seq       -s -w 0 >> chr4.fa                                                
...
samtools faidx ${ontasm}     Contig9:197712619-250301541                        | seqkit seq       -s -w 0 >> chr4.fa                                                            
samtools faidx ${theread}    fa2744b0-0118-4bb9-ad7d-ff58ab60eb92:236882-236897 | seqkit seq       -s -w 0 >> chr4.fa                                                                                   

# chr5
echo -e ">chr5" > chr5.fa
samtools faidx ${theread}    cb1be39b-aff9-4e95-883d-cc4d9a1aa66a:161998-193197 | seqkit seq -r -p -s -w 0 >> chr5.fa
samtools faidx ${ontasm}     Contig10:25655-204554320                           | seqkit seq       -s -w 0 >> chr5.fa      
...
samtools faidx ${ontasm}     Contig17:13701186-27726502                         | seqkit seq       -s -w 0 >> chr8.fa     
samtools faidx ${theread}    3f94e2ef-3def-4d3b-bab4-2938c4d655dc:207300-207360 | seqkit seq       -s -w 0 >> chr8.fa                             
...
chr9.fa \
chr10.fa \
| seqkit seq - > Mo17.unpolished.fa
seqkit fx2tab -nl Mo17.unpolished.fa > Mo17.unpolished.fa.len 
seqkit stat -a Mo17.unpolished.fa > Mo17.unpolished.fa.stat
